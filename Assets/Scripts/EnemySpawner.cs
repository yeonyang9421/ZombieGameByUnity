...
public class EnemySpawner : MonoBehaviour
{
    ...
    public float speedMax = 0.5f; // 최대 속도
    public float speedMin = 0.1f; // 최소 속도
    ...
    private void CreateEnemy(float intensity)
    {
        ...
        float demage = Mathf.Lerp(damageMin, damageMax, intensity);
        ...
        enemy.Setup(health, demage, speed, skinColor);
